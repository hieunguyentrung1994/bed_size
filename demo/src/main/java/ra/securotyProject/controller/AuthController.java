...
public class AuthController {
    ...
    public ResponseEntity<String> getSomeData(@RequestHeader("Authorization") String token) {
...
@PostMapping("/orderAddNew/{idUser}")
    public ResponseEntity<OrderDetailResponse> addOrder(@PathVariable Long idUser,@RequestBody OrderDetailRequest request){
        return ResponseEntity.ok(orderDeTailService.addSave(request,idUser));
}
